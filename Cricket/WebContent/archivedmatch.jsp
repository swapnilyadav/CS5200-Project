...
<%
		...
		List<ArchivedMatch> matches = matchDao.retrieveAllArchivedMatches();
		
		for(ArchivedMatch match : matches){
	%>
		<tr>
		<td><a href="archivedmatchdetail.jsp?id=<%=match.getArchivedmatchid() %>" target="_blank"><%= match.getArchivedmatchname() %></a></td>
		<td><%= match.getArchivedmatchno()%></td>	
		<td><%= match.getArchivedmteam1() %></td>
		<td><%= match.getArchivedmteam2()%></td>
		<td><%= match.getArchivedmatchtype() %></td>
		<td><%= match.getArchivedmatchseries()%></td>
		<td><%= match.getArchivedmstartdate()%></td>
		<td><%= match.getArchivedmenddate()%></td>
		<td><%= match.getArchivedmstatus()%></td>
		</tr>
